...
public class fNhaCungCap extends JFrame {
	...
	public fNhaCungCap() {
		...
		btnThem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					pst.setString(1,txtMaNCC.getText().toString());
					pst.setString(2,txtTenNCC.getText().toString());
		...
		btnThem.setBounds(10, 386, 72, 21);
		...
		btnSua.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					String gt;
					pst.setString(1, txtTenNCC.getText().toString());
					pst.setString(2,txtDiaChi.getText());
					pst.setString(3,txtSDT.getText());
					pst.setString(4,txtMaNCC.getText());
					pst.executeUpdate();
		...
		btnXoa.setBounds(173, 386, 79, 21);
